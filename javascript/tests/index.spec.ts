...
describe('Function', () => {
  ...
  it('should return the assertion error', () => {
    assert.throws(() => { Collatz.Function({n:1n, P:0n, a:2n, b:3n}) }, Collatz.FailedSaneParameterCheck, Collatz._ErrMsg.SANE_PARAMS_P);
    assert.throws(() => { Collatz.Function({n:1n, P:0n, a:0n, b:3n}) }, Collatz.FailedSaneParameterCheck, Collatz._ErrMsg.SANE_PARAMS_P);
    assert.throws(() => { Collatz.Function({n:1n, P:1n, a:0n, b:3n}) }, Collatz.FailedSaneParameterCheck, Collatz._ErrMsg.SANE_PARAMS_A);
  });
});
