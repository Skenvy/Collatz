...
(function (Collatz) {
    ...
    Collatz._KNOWN_CYCLES = [[1n, 4n, 2n], [-1n, -2n], [-5n, -14n, -7n, -20n, -10n],
    ...
    Collatz.__VERIFIED_MAXIMUM = 295147905179352825856n;
    // The value down to which has been proven numerically, for the default parameterisation."
    Collatz.__VERIFIED_MINIMUM = -272n; // TODO: Check the actual lowest bound.
    ...
    })(_ErrMsg = Collatz._ErrMsg || (Collatz._ErrMsg = {}));
    ...
    Collatz.FailedSaneParameterCheck = FailedSaneParameterCheck;
    ...
    Collatz.__assert_sane_parameterisation = __assert_sane_parameterisation;
    // """
    ...
    Collatz.Function = Function;
})(Collatz = exports.Collatz || (exports.Collatz = {}));
exports.default = {
    Collatz
};
