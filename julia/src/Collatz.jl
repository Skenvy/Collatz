...
"""
module _CC
# Access as string(ABC::CC) or just string(ABC)
@enum CC begin
    STOPPING_TIME
    TOTAL_STOPPING_TIME
    CYCLE_INIT
...
# def reverse_function(n::Integer, P::Integer=2, a::Integer=3, b::Integer=1):
    """
...
# def __initial_value_outside_verified_range(x::Integer):
    """
...
# def __stopping_time_terminus(n::Integer, total_stop:bool):
    """
...
# def hailstone_sequence(initial_value::Integer, P::Integer=2, a::Integer=3,
#                        b::Integer=1, max_total_stopping_time::Integer=1000,
...
# def stopping_time(initial_value::Integer, P::Integer=2, a::Integer=3,
#                   b::Integer=1, max_stopping_time::Integer=1000,
...
# def tree_graph(initial_value::Integer, max_orbit_distance::Integer, P::Integer=2, a::Integer=3,
#                b::Integer=1, __cycle_prevention:Optional[Set[int]]=None):
    """
