...
#     expect_equal(Double.valueOf(0), wrapStoppingTime(0));
# })
...
#     expect_equal(Double.valueOf(0), wrapStoppingTime(1));
#     # 1's cycle wont yield a description of it being a "cycle" as far as the
#     # hailstones are concerned, which is to be expected, so..
#     expect_equal(Double.valueOf(2), wrapStoppingTime(4, 100, true));
#     expect_equal(Double.valueOf(4), wrapStoppingTime(16, 100, true));
# })
...
#             for(BigInteger c : kc){
#                 expect_equal(Double.valueOf(Double.POSITIVE_INFINITY), wrapStoppingTime(c.longValue(), 100, true));
#             }
#         }
#     }
# })
...
#     expect_equal(Double.valueOf(Double.POSITIVE_INFINITY), wrapStoppingTime(-56, 100, true));
#     expect_equal(Double.valueOf(Double.POSITIVE_INFINITY), wrapStoppingTime(-200, 100, true));
# })

# test_that("StoppingTime_RegularStoppingTime", {
#     # Test the regular stopping time check.
#     expect_equal(Double.valueOf(1), wrapStoppingTime(4));
#     expect_equal(Double.valueOf(3), wrapStoppingTime(5));
# })

# test_that("StoppingTime_NegativeMaxTotalStoppingTime", {
#     # Test small max total stopping time: (minimum internal value is one)
#     expect_equal(null, wrapStoppingTime(5, -100, true));
# })

# test_that("StoppingTime_ZeroStopMidHail", {
#     # Test the zero stop mid hailing. This wont happen with default params tho.
#     expect_equal(Double.valueOf(-1), wrapStoppingTime(3, 2, 3, -9, 100, false));
# })
...
#     expect_equal(Double.valueOf(Double.POSITIVE_INFINITY), wrapStoppingTime(3, 1, 3, 1, 100, false));
#     expect_equal(Double.valueOf(Double.POSITIVE_INFINITY), wrapStoppingTime(3, -1, 3, 1, 100, false));
# })

# test_that("StoppingTime_MultiplesOf576460752303423488Plus27", {
#     # One last one for the fun of it..
#     expect_equal(Double.valueOf(111), wrapStoppingTime(27, 1000, true));
...
#     expect_error(StoppingTime(1, 0, 2, 3, 1000, false), Collatz$SaneParameterErrMsg$P)
#     expect_error(StoppingTime(1, 0, 0, 3, 1000, false), Collatz$SaneParameterErrMsg$P)
#     expect_error(StoppingTime(1, 1, 0, 3, 1000, false), Collatz$SaneParameterErrMsg$A)
# })
