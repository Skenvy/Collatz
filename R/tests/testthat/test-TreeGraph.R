...
#     expect_error(TreeGraph(1, 1, 0, 2, 3), Collatz$SaneParameterErrMsg$P)
#     expect_error(TreeGraph(1, 1, 0, 0, 3), Collatz$SaneParameterErrMsg$P)
#     expect_error(TreeGraph(1, 1, 1, 0, 3), Collatz$SaneParameterErrMsg$A)
# })
